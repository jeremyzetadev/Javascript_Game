...
export class SittingLeft extends State{
    ...
    handleInput(input){
        ...
        else if(input==='RELEASE down') this.player.setState(states.STANDING_LEFT); //if comment out will stay sitting when key-release
    }
}
...
export class SittingRight extends State{
    ...
    handleInput(input){
        ...
        else if(input==='RELEASE down') this.player.setState(states.STANDING_RIGHT);  //if comment out will stay sitting when key-release
    }
}
